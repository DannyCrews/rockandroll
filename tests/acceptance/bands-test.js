...
test('List bands', function(assert) {
  ...
  visit('/bands');
    ...
    andThen(function() {
      ...
      assertLength(assert, '.band-link:contains("Radiohead")',
       1, 'First band link contains the band name');
...
test('Search songs', function(assert) {
  ...
  andThen(function() {
    assertTrimmedText(assert, '.song:first', 'No One Loves Me & Neither Do I',
      'A matching song that comes later in the alphahet appears on top');
